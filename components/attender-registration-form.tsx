...
export function AttenderRegistrationForm() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const csvData = [
      ...
      ["Attender ID", formData.attenderId],
      ["Attender Name", formData.attenderName],
    ...
    link.setAttribute("download", "attender_registration.csv");
  ...
  return (
    <Card className="max-w-4xl mx-auto bg-[#1e2532] text-white border-none shadow-xl">
      <CardHeader className="text-center">
        <CardTitle className="text-2xl font-bold">Attender Registration</CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { id: "attenderId", label: "Attender ID", maxLength: 8 },
              { id: "attenderName", label: "Attender Name", maxLength: 20 },
